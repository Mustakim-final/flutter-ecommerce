...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void signIn() async{
    try{
      ...
      final User? user=(await firebaseAuth.signInWithEmailAndPassword(email: _eamilController.text.trim(), password: _passwordController.text.trim())).user;
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          customButton("Sign in",(){
                            if(_eamilController.text.trim()=="admin"){
